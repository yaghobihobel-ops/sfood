...
return new class extends Migration
{
    ...
    {
        Schema::create('food_seo_data', function (Blueprint $table) {
            $table->id();
            $table->foreignId('food_id')->nullable()->index();
            $table->foreignId('item_campaign_id')->nullable()->index();
    ...
    {
        Schema::dropIfExists('food_seo_data');
    }
};
