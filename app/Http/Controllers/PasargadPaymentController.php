...
class PasargadPaymentController extends Controller
{
    ...
    /**
     * Redirect the user to Pasargad (PEP) payment page.
     */
    public function pay(Request $request): RedirectResponse|JsonResponse|FoundationApplication|Redirector
    {
        ...
        try {
            ...
            Log::warning('Pasargad pay failed', [
    ...
    /**
     * Handle Pasargad callback and mark the payment accordingly.
     */
    public function callback(Request $request): RedirectResponse|JsonResponse|FoundationApplication|Redirector
    {
        $paymentId = $request->input('payment_id', $request->input('iN')); // invoiceNumber fallback
        ...
        try {
            ...
            Log::warning('Pasargad callback failed', [
                'payment_id' => $payment->id,
                'error' => $exception->getMessage(),
            ]);
