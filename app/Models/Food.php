...
class Food extends Model
{
    ...
    public function rating()
    {
        ...
        //     ->select(DB::raw('avg(rating) average, count(food_id) rating_count,  count(food_id) review_count where notnull comment, food_id'   ))
        //     ->groupBy('food_id');
        ...
        return $this->hasMany(Review::class)
            ->select(
                ...
                DB::raw('COUNT(food_id) as rating_count'),
