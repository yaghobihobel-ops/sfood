                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs mt-3">
                    ...
                    @if (Helpers::module_permission_check('report'))
                        ...
                        <li class="navbar-vertical-aside-has-menu @yield('tax_report')">
                            <a class="nav-link " href="{{ route('admin.report.getTaxReport') }}" title="{{ translate('Tax_Report') }}">
                        ...
                        <li class="navbar-vertical-aside-has-menu @yield('vendor_tax_report')">
                            <a class="nav-link " href="{{ route('admin.report.vendorWiseTaxes') }}" title="{{ translate('Restaurant_VAT_Report') }}">
                                <span class="tio-american-express nav-icon"></span>
                                <span class="text-truncate text-capitalize">{{ translate('Restaurant_VAT_Report') }}</span>
                            </a>
                        </li>
                    @endif
                ...
                <li
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('admin.business-settings.react-registration-page.hero') }}"
