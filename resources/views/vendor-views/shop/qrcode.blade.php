                    ...
                    <div class="qr-area row gy-4">
                        <div class="col-lg-6 col-xl-5 left-side">
                            ...
                            <div class="qr-wrapper">
                                ...
                                <span>
                                    {{ data_get($data,'description', translate('Check our menu online, just open your phone & scan this QR Code'))}}
                                </span>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" placeholder="{{ translate('Ex : Description') }}"
                                                   value="{{ data_get($data,'description', old('description'))}}"
