...
<div class="table-responsive datatable-custom">
    <table id="columnSearchDatatable"
        ...
        <tr>
            ...
            <th class="w-33p-customize text-center">{{translate('messages.time')}}</th>
            <th class="w-33p-customize">{{translate('messages.status')}}</th>
            <th class="w-33p-customize">{{translate('messages.Delivery Man')}}</th>
        </tr>
        </thead>
