            ...
            @if(isset($data['1']) && count($data['1']))
                @foreach ($data['1'] as $day)
                    <span class="d-inline-flex align-items-center">
                        ...
                        <span class="dismiss--date delete-schedule" data-url="{{route('vendor.business-settings.remove-schedule',['restaurant_schedule'=>$day['id']])}}"><i class="tio-clear-circle-outlined"></i></span></span>
                @endforeach
            @else
