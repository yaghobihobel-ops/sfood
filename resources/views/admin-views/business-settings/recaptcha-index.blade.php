                ...
                <form
                    ...
                    <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control mb-4">
                        ...
                        <input type="checkbox"
                               ...
                               data-type="toggle"
                               data-image-on="{{ dynamicAsset('/public/assets/admin/img/modal/important-recapcha.png') }}"
                               data-image-off="{{ dynamicAsset('/public/assets/admin/img/modal/warning-recapcha.png') }}"
