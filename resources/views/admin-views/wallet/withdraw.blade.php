                                ...
                                @foreach($withdraw_req as $k=>$wr)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="deco-none"
                                               href="{{route('admin.restaurant.view',[$wr->vendor->restaurants[0]->id])}}">{{ Str::limit($wr->vendor?$wr->vendor->restaurants[0]->name:translate('messages.Restaurant_deleted!'), 20, '...') }}</a>
                                            @else
