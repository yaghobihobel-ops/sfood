                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        <div class="mb-2">
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 30 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the subtitle under 70 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the description under 70 character for better visualisation.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Footer Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Provide final engagement opportunities and essential information that builds trust and keeps customers connected to your brand.')}}</li>
                                <li>{{translate('Build trust through transparency about terms, privacy, and refunds.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
