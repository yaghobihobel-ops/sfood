                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        ...
                        <div>
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 80 character for better visualization.')}}</li>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Gallery Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('To create appetite appeal and visual desire through high-quality food imagery that makes users want to order immediately.')}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Image Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Shows the actual quality and presentation customers can expect.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
