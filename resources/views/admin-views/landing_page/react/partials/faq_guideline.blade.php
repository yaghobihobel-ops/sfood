                    ...
                    <div class="card card-body">
                        <div class="mb-2">
                            ...
                            <ul class="mb-0">
                                ...
                                <li>{{translate('Keep the description under 60 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the question under 150 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the answer under 500 character for better visualisation.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('FAQ Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Reduce customer service workload and build trust by proactively answering common questions before users need to contact support.')}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('FAQ Q&A Setup')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Add Q&A that shows you understand customer needs and pain points, builds trust through transparency and helpful information')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
