                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        <div class="mb-2">
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 20 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the subtitle under 20 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the description under 100 character for better visualisation.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Earn Money Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Grow your business ecosystem by recruiting high-quality restaurant partners and delivery drivers to expand your service capacity and coverage.')}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Restaurant Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('To encourage new restaurant owners to register and partner with your StackFood platform and to provide a download link for the restaurant management app.')}}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Deliveryman Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('To invite potential delivery partners to register as deliverymen and to give them a direct link to download the Deliveryman App.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
