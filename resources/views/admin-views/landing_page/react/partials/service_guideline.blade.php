                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        ...
                        <div>
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 20 character for better visualization.')}}</li>
                                <li>{{translate('Keep the subtitle under 60 character for better visualization.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Service Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Showcase your key features that make your food delivery service great! These are the benefits customers see right after your main banner.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
