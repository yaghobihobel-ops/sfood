                    ...
                    <div class="card card-body">
                        <div class="mb-2">
                            ...
                            <ul class="mb-0">
                                ...
                                <li>{{translate('Keep the image under 2MB')}}</li>
                            </ul>
                        </div>
                        <div>
                            <h5 class="mb-2">{{translate('For Content')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 60 character for better visualization.')}}</li>
                                <li>{{translate('Keep the subtitle under 100 character for better visualization.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Available zone Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Clearly communicate your service coverage area to set proper customer expectations and prevent failed orders.')}}</li>
                                <li>{{translate('Switch the status on to display this section to users; turn it off to remove it from the landing page.')}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Location Picker Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('To instantly match customers with your service availability, creating immediate relevance and preventing failed order attempts.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
