                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        <div class="mb-2">
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 60 character for better visualisation.')}}</li>
                                <li>{{translate('Keep the subtitle under 100 character for better visualisation.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Download App Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Convert website visitors into loyal app users by showcasing the benefits of your mobile application.')}}</li>
                                <li>{{translate('Add Play store and Apple store link for significantly increase install rates.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
