                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        ...
                        <div>
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 50 character for better visualization.')}}</li>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Header Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('This is where you control the first thing visitors see. Let\'s make a great first impression that turns visitors into customers.')}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Location Picker')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Helps visitors find restaurants in their area.')}}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Business Statistic')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Shows visitors that you\'re popular and reliable.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
