            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Testimonial Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Build trust and credibility by showcasing real customer experiences that convince new users to try your service.')}}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            <h5 class="mb-2">{{translate('Add Reviewers')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Add reviewers to build social proof to shows that real people enjoy and trust your service.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
