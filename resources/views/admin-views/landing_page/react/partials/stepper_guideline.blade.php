            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Stepper Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Show customers how quick and easy it is to order food through your platform. This builds confidence and reduces hesitation for first-time users.')}}</li>
                            </ul>
                        </div>
                    </div>
