                ...
                <div class="collapse mt-3 show" id="collapseGeneralSetup_01">
                    <div class="card card-body">
                        <div class="mb-2">
                            ...
                            <ul class="mb-0">
                                <li>{{translate('Keep the title under 80 character for better visualisation.')}}</li>
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    <div class="card card-body mt-3">
                        <div class="mb-2">
                            <h5 class="mb-2">{{translate('Category Section')}}</h5>
                            <ul class="mb-0">
                                <li>{{translate('Help customers quickly find and browse food by type, making restaurant discovery fast and intuitive.')}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
