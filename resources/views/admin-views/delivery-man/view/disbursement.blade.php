        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('admin.delivery-man.preview', ['id'=>$dm->id, 'tab'=> 'disbursement'])}}"  aria-disabled="true">{{translate('messages.disbursements')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                ...
                <div class="search--button-wrapper">
                    ...
                    <div class="hs-unfold ml-3">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{route('admin.delivery-man.disbursement-export', ['id'=>$dm->id,'type'=>'excel',request()->getQueryString()])}}">
                            ...
                            <a id="export-csv" class="dropdown-item" href="{{route('admin.delivery-man.disbursement-export', ['id'=>$dm->id,'type'=>'excel',request()->getQueryString()])}}">
                                                            ...
                                                            <div class="item w-100">
                                                                ...
                                                                <ul class="item-list">
                                                                    <li class="d-flex flex-wrap">
                                                                        ...
                                                                        <strong>{{$disbursement?->withdraw_method?->method_name ?? translate('Default_method')}}</strong>
                                                                    </li>
                                                                    <li class="d-flex flex-wrap">
